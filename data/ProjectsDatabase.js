...
const ProjectDatabase = () => {
    const allProjects = {
        ...
        "Employee Gamification Platform": {
            date: 2023,
            description:
                "A Mobile Platform that enhances the worklife of employees through gamification of routine work and social aspects of the worklife. \nWon Best MVP in Hackathon",
            image: "/project-imgs/EmployeeGamification_0.png",
            tags: ["React Native", "Javascript", "NodeJS", "Firebase"],
            linkGithub: "https://github.com/JamesCrr/CodeEXP-2023",
            linkDemo: "",
            linkVid: "",
        },
        ...
        "Pathfinding & AI": {
            date: 2018,
            description:
                "Project to learn about Pathfinding algorithms and how to apply them. Implemented algorithms such as A*, DFS, BFS.",
